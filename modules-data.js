...
const c1Modules = [
  {
    ...
    vocabulary: [
      { word: "Acquiesce", type: "verb", def: "To accept something reluctantly but without protest.", ex: "Despite her reservations about the new policy, she decided to acquiesce to the board's decision.", stress: "ac-qui-ESCE", coll: "acquiesce to a demand, acquiesce in a decision", arabic: "يذعن / يرضخ", ipa: "/ˌæk.wiˈes/", syllables: "ac·qui·esce" },
      { word: "Capricious", type: "adjective", def: "Given to sudden and unaccountable changes of mood or behavior.", ex: "The administration's capricious decisions left the employees feeling insecure about their jobs.", stress: "ca-PRI-cious", coll: "capricious climate, capricious market, capricious behavior", arabic: "متقلب / نزوي", ipa: "/kəˈprɪs.əs/", syllables: "ca·pri·cious" },
      { word: "Dearth", type: "noun", def: "A scarcity or lack of something.", ex: "There is a dearth of reliable information regarding the long-term effects of the new treatment.", stress: "DEARTH", coll: "dearth of resources, dearth of evidence, dearth of talent", arabic: "ندرة / قلة", ipa: "/dɝːθ/", syllables: "dearth" },
      { word: "Ephemeral", type: "adjective", def: "Lasting for a very short time; fleeting.", ex: "Fame in the internet age is often ephemeral, lasting only a few days.", stress: "e-PHE-me-ral", coll: "ephemeral gold sunset, ephemeral beauty, ephemeral fame", arabic: "زائل / سريع الزوال", ipa: "/ɪˈfem.ər.əl/", syllables: "e·phem·er·al" },
      { word: "Fastidious", type: "adjective", def: "Very attentive to and concerned about accuracy, detail, and cleanliness.", ex: "The accountant was fastidious in keeping records, ensuring every transaction was documented.", stress: "fa-STID-i-ous", coll: "fastidious planner, fastidious researcher, fastidious attention", arabic: "دقيق جداً / صعب الإرضاء", ipa: "/fæsˈtɪd.i.əs/", syllables: "fas·tid·i·ous" },
      { word: "Ineffable", type: "adjective", def: "Too great or extreme to be expressed or described in words.", ex: "Standing at the edge of the Grand Canyon, she was filled with an ineffable sense of awe.", stress: "in-EFF-a-ble", coll: "ineffable light, ineffable joy, ineffable sadness", arabic: "لا يوصف / يفوق الوصف", ipa: "/ɪnˈef.ə.bəl/", syllables: "in·ef·fa·ble" },
      { word: "Mitigate", type: "verb", def: "To make something less severe, serious, or painful.", ex: "The company took steps to mitigate the environmental impact of its manufacturing processes.", stress: "MI-ti-gate", coll: "mitigate the risks, mitigate the damage, mitigate the impact", arabic: "يخفف / يلطف", ipa: "/ˈmɪt̬.ə.ɡeɪt/", syllables: "mit·i·gate" },
      { word: "Nefarious", type: "adjective", def: "Wicked, villainous, or criminal.", ex: "The hacker group hatched a nefarious scheme to steal sensitive financial data.", stress: "ne-FA-ri-ous", coll: "nefarious merchant, nefarious plot, nefarious activities", arabic: "شنيع / خبيث / شرير", ipa: "/nəˈfer.i.əs/", syllables: "ne·far·i·ous" },
      { word: "Obfuscate", type: "verb", def: "To deliberately make something obscure, unclear, or unintelligible.", ex: "The politician attempted to obfuscate the truth by giving long, winded, and evasive answers.", stress: "OB-fus-cate", coll: "obfuscate the route, obfuscate the truth, obfuscate the facts", arabic: "يغمض / يضلل / يشوش", ipa: "/ˈɑːb.fə.skeɪt/", syllables: "ob·fus·cate" },
      { word: "Plausible", type: "adjective", def: "Seeming reasonable, probable, or believable.", ex: "While his excuse was plausible, the manager still requested documentation to verify his story.", stress: "PLAU-si-ble", coll: "plausible explanation, plausible route, plausible excuse", arabic: "معقول / مقنع / ممكن تصديقه", ipa: "/ˈplɑː.zə.bəl/", syllables: "plau·si·ble" },
      { word: "Superfluous", type: "adjective", def: "Unnecessary, especially through being more than enough.", ex: "The editor cut out the superfluous adjectives to make the article more concise and impactful.", stress: "su-PER-flu-ous", coll: "superfluous details, superfluous expenditure, superfluous graphs", arabic: "زائد عن الحاجة / غير ضروري", ipa: "/suːˈpɝː.flu.əs/", syllables: "su·per·flu·ous" },
      { word: "Taciturn", type: "adjective", def: "Reserved or uncommunicative in speech; saying little.", ex: "Known as a taciturn man, he rarely spoke in meetings unless directly asked a question.", stress: "TA-ci-turn", coll: "taciturn scholar, taciturn man, taciturn nature", arabic: "كتوم / قليل الكلام / صموت", ipa: "/ˈtæs.ə.tɝːn/", syllables: "tac·i·turn" }
    ],
